...
## Why Next.js?
We need server environment for using Notion's Javascript SDK. The server-side acts as an BFF layer between Notion and the client-side. Plus, Next.js support dockerization via standalone output.
