...
export function useFilterState({
  ...
  const [maxNestingDepth, setMaxNestingDepth] =
    useState<number>(maxNestingDepthProp)
  ...
  // Sync maxNestingDepth with prop changes
  useEffect(() => {
    if (maxNestingDepthProp !== undefined) {
      setMaxNestingDepth(maxNestingDepthProp)
    }
  }, [maxNestingDepthProp])
